...
# Verify `create-jilatax` NPM package ✅

## 1 — npm Token **Settings**

```text
https://www.npmjs.com/package/create-jilatax/access
```

| Field | Value |
| --- | --- |
| Organization or user | `bastndev` |
| Repository | `create-jilatax` |
